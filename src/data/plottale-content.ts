...
const NOVELS: PlottaleNovel[] = [
  ...
  },
  {
    ...
    synopsis: {
      en: "Four strangers discover they share the same recurring nightmare — and the face that haunts them belongs to someone very much alive. As they dig deeper into the mystery, each stranger uncovers a buried connection to a decades-old disappearance that the town has tried to forget. Four strangers discover they share the same recurring nightmare — and the face that haunts them belongs to someone very much alive. Drawn together by visions they cannot explain, they must confront the darkness lurking beneath the surface of their own memories before the nightmare consumes them all.",
...
const CHARACTERS: PlottaleCharacter[] = [
  ...
  },
  {
    ...
    handle: "@kiraaydin",
    role: { en: "Lead detective haunted by a recurring nightmare that connects four strangers to a decades-old disappearance", th: "นักสืบผู้ถูกหลอกหลอนด้วยฝันร้ายซ้ำๆ ที่เชื่อมโยงคนแปลกหน้าสี่คนกับการหายตัวเมื่อหลายสิบปีก่อน" },
    bio: {
  ...
  },
  {
    ...
    handle: "@miasynth",
    role: { en: "Synthetic human assistant who begins remembering a life she was never programmed to have", th: "ผู้ช่วย AI ที่เริ่มจำชีวิตที่เธอไม่เคยถูกโปรแกรมให้มี" },
    bio: {
  ...
  // Novel 3 – Saklı
  { id: "c27", name: { en: "Emre Demir", th: "เอมเร เดเมียร์" }, handle: "@emredemir", role: { en: "Psychiatrist treating four patients who share the same impossible nightmare — questioning his own sanity", th: "จิตแพทย์ที่รักษาผู้ป่วยสี่คนที่ฝันร้ายเหมือนกัน — เริ่มสงสัยในสติตัวเอง" }, bio: { en: "The doctor treating four patients who share the same impossible nightmare.", th: "แพทย์ที่รักษาผู้ป่วยสี่คนที่ฝันร้ายเหมือนกัน" }, avatar: "/plottale/avatars/char-c1.jpg", banner: "/plottale/avatars/banner-c1.jpg", placeholderGradient: "linear-gradient(145deg, #1b5e20 0%, #81c784 100%)", followers: 16200, following: 3400, novelCount: 1, novelIds: ["3"], verified: true },
  { id: "c28", name: { en: "Zeynep Kaya", th: "เซย์เนป คายา" }, handle: "@zeynepkaya", role: { en: "Art student who sketches her nightmares in vivid detail — every drawing matches reality", th: "นักศึกษาศิลปะที่วาดฝันร้ายอย่างละเอียด — ทุกภาพตรงกับความจริง" }, bio: { en: "She draws the nightmares — every detail matches reality.", th: "เธอวาดฝันร้าย — ทุกรายละเอียดตรงกับความจริง" }, avatar: "/plottale/avatars/char-c9.jpg", banner: "/plottale/avatars/banner-c9.jpg", placeholderGradient: "linear-gradient(145deg, #b71c1c 0%, #ef9a9a 100%)", followers: 11400, following: 2800, novelCount: 1, novelIds: ["3"], verified: false },
  { id: "c29", name: { en: "Tarik Aslan", th: "ทาริค อัสลัน" }, handle: "@tarikaslan", role: { en: "Investigative journalist digging into the nightmare connection — until he starts having them too", th: "นักข่าวสายสืบสวนที่ค้นหาความเชื่อมโยงของฝันร้าย — จนเขาเริ่มฝันเห็นเหมือนกัน" }, bio: { en: "Investigating the nightmare connection — until he starts having them too.", th: "สืบสวนเรื่องฝันร้ายที่เชื่อมโยงกัน — จนเขาเริ่มฝันเห็นเหมือนกัน" }, avatar: "/plottale/avatars/char-c4.jpg", banner: "/plottale/avatars/banner-c4.jpg", placeholderGradient: "linear-gradient(145deg, #263238 0%, #90a4ae 100%)", followers: 8900, following: 1500, novelCount: 1, novelIds: ["3"], verified: false },
  { id: "c30", name: { en: "Defne Yıldız", th: "เดฟเน ยิลดิซ" }, handle: "@defneyildiz", role: { en: "Town pharmacist who discovers the prescribed medications were never meant to cure anything", th: "เภสัชกรประจำเมืองที่ค้นพบว่ายาที่สั่งจ่ายไม่เคยถูกออกแบบมาเพื่อรักษา" }, bio: { en: "She knows the pills aren't working — because they were never meant to.", th: "เธอรู้ว่ายาไม่ได้ผล — เพราะมันไม่เคยถูกออกแบบมาเพื่อรักษา" }, avatar: "/plottale/avatars/char-c7.jpg", banner: "/plottale/avatars/banner-c7.jpg", placeholderGradient: "linear-gradient(145deg, #4a148c 0%, #ce93d8 100%)", followers: 6700, following: 1100, novelCount: 1, novelIds: ["3"], verified: false },
  { id: "c31", name: { en: "Ozan Çelik", th: "โอซาน เชลิค" }, handle: "@ozancelik", role: { en: "Night security guard who watches the CCTV — what he sees at 3 AM shouldn't be possible", th: "ยามรักษาความปลอดภัยกลางคืนที่เฝ้าดูกล้อง — สิ่งที่เขาเห็นตอนตี 3 ไม่ควรเป็นไปได้" }, bio: { en: "He watches the cameras — and what he sees at 3 AM shouldn't be possible.", th: "เขาเฝ้าดูกล้องวงจรปิด — และสิ่งที่เห็นตอนตี 3 ไม่ควรเป็นไปได้" }, avatar: "/plottale/avatars/char-c6.jpg", banner: "/plottale/avatars/banner-c6.jpg", placeholderGradient: "linear-gradient(145deg, #0d47a1 0%, #64b5f6 100%)", followers: 4500, following: 670, novelCount: 1, novelIds: ["3"], verified: false },
  { id: "c32", name: { en: "Ayşe Eren", th: "อายเช เอเรน" }, handle: "@ayseeren", role: { en: "The oldest patient in the ward — she claims she saw this exact nightmare sixty years ago", th: "ผู้ป่วยที่อายุมากที่สุดในตึก — เธออ้างว่าเคยเห็นฝันร้ายนี้เมื่อหกสิบปีก่อน" }, bio: { en: "The oldest patient who claims she's seen this nightmare before — sixty years ago.", th: "ผู้ป่วยที่อายุมากที่สุดที่อ้างว่าเคยเห็นฝันร้ายนี้ — เมื่อหกสิบปีก่อน" }, avatar: "/plottale/avatars/char-c8.jpg", banner: "/plottale/avatars/banner-c8.jpg", placeholderGradient: "linear-gradient(145deg, #3e2723 0%, #a1887f 100%)", followers: 3200, following: 90, novelCount: 1, novelIds: ["3"], verified: false },
  { id: "c33", name: { en: "Selim Barış", th: "เซลิม บาริช" }, handle: "@selimbaris", role: { en: "Skeptical police chief who doesn't believe in nightmares — until the physical evidence starts matching", th: "ผู้กำกับตำรวจผู้ไม่เชื่อเรื่องฝันร้าย — จนหลักฐานทางกายภาพเริ่มตรงกัน" }, bio: { en: "He doesn't believe in nightmares — until the evidence starts matching.", th: "เขาไม่เชื่อเรื่องฝันร้าย — จนหลักฐานเริ่มตรงกัน" }, avatar: "/plottale/avatars/char-c10.jpg", banner: "/plottale/avatars/banner-c10.jpg", placeholderGradient: "linear-gradient(145deg, #1a237e 0%, #7986cb 100%)", followers: 7800, following: 430, novelCount: 1, novelIds: ["3"], verified: true },
  // Novel 4 – Yuna
